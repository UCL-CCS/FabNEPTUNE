...
if __name__ == '__main__':
    ...
    try:
        ...
        # columnsfrem = ['index', 'Time', 'F1-visc_L', 'F1-total_L', 'F2-press_L', 'F2-visc_L', 'F2-total_L',
        #             'F1-pres_R', 'F1-visc_R', 'F1-total_R', 'F2-press_R', 'F2-visc_R', 'F2-total_R']
        columnsfrem = ['index', 'Time', 'F1-total_L', 'F2-press_L', 'F2-visc_L', 'F2-total_L', 'F1-total_R', 'F2-press_R', 'F2-visc_R', 'F2-total_R']
        # output1_path = c_path + '/' + str(sec) + '/' + str(first) + '/output1.csv'
